...
class AnnouncementsController(Resource):
    ...
    def post(current_user):
        ...
        announcement_data['group'] = DiscussionGroupsRepository.get_discussion_group_for_id(group_id).name
        announcement_data['author'] = f'{current_user.first_name} {current_user.last_name}'
        send(announcement_data, broadcast=True, namespace='', to=int(group_id))
